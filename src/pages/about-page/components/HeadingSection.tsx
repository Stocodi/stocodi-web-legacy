    ...
    return (
        <div className="landing-page__heading">
            ...
            <p className="landing-page__heading-paragraph">
                <span>스토코디는 청년들에게</span>
                <span>금융과 투자에 대한 기초를</span>
            ...
            <div className="landing-page__about-container">
                ...
                <p className="landing-page__about-item">
                    ...
                    <span>어렵게 느껴지는 금융지식과 투자용어를 쉽고 재밌게 알려주고</span>
                    <span>청년들에게 금융과 투자에 대한 심리적 장벽을 낮춰 주는 것을</span>
                    <span>목표로 하고 있습니다</span>
                </p>
            </div>
        </div>
    );
